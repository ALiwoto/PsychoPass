...
type SibylSystemConfig struct {
	...
	// -1 for unlimited.
	MaxPanic int64 `section:"general" key:"max_panic" default:"-1"`
	...
	BotAPIUrl string `section:"telegram" key:"bot_api_url"`

	DropUpdates bool `section:"telegram" key:"drop_updates" default:"true"`
	// CmdPrefixes is the command prefixes of the bot.
	CmdPrefixes []string `section:"telegram" key:"cmd_prefixes" default:"/"`
